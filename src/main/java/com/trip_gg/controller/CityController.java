...
public class CityController {
    ...
    @GetMapping
    public ResponseEntity<List<CityResponseDto>> getAllCities(@RequestParam("countryId") int countryId){
        List<CityResponseDto> cities = cityService.getAllCities(countryId);
